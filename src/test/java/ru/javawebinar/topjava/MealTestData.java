...
public class MealTestData {
    ...
    public static final LocalDateTime START_DATE_TIME = of(2015, Month.MAY, 30, 7, 0);
    public static final LocalDateTime END_DATE_TIME = of(2015, Month.MAY, 30, 15, 0);
    ...
    public static final List<MealTo> MEALSTO = getWithExcess(MEALS, DEFAULT_CALORIES_PER_DAY);
